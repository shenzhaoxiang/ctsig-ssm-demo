...
Source Database       : db_ctsig_ssm_demo
...
*/
CREATE DATABASE IF NOT EXISTS `db_ctsig_ssm_demo` DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

USE `db_ctsig_ssm_demo`;
...
CREATE TABLE `tb_goods` (
  ...
  `GOODS_DATE` TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '添加时间',
